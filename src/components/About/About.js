            ...
            <Container >
                ...
                <Row>
                    <Col className={classes.Content}>
                        ...
                        <br />
                        <br />
                        I'm Ayush! -  software developer, with a passion for technology and learning. Always enthusiastic by new idea, and willingness to contribute towards a valuable end product is what pushes me.
                        <br />
                        <br />
                        I got introduced to programming in 11th standard when I opted for computer science as an optional subject. I end up scoring <i>17/100</i> marks in my final exam. I failed because things were not making sense. I had too many questions, how come 1+1 is 0, and why <i>a=10</i> works but <i>10=a</i> doesn't, why do we need <i>++a</i> when we have <i>a++</i>. All these things were very complex for a 15-year old child but, after some time everything started to make sense and once I got over the hump I haven't looked back. I got in touch with newer and more modern technologies like Machine Learning, Cloud, Web-development and I just fell in love with programming all over again, after that is still the challenges that get me going.
                        <br />
                        <br />
